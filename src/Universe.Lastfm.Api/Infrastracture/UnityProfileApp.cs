...
namespace Universe.Lastfm.Api.Infrastracture
{
    ...
    public class UnityProfileApp
    {
        ...
        {
            // Infrastructure
            _container.RegisterFactory<IUniverseScope>((ct) =>
            {
                var settings = ct.Resolve<IUniverseLastApiSettings>(UnityRegistrations.ExternalAppSettings);
                return new UniverseLastApiScope(settings, ct);
