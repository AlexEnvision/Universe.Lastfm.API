...
namespace Universe.Lastfm.Api.Dal.Command.Tracks
{
    ...
    public class UpdateTrackAsLoveCommand : LastCommand<UpdateTrackAsLoveRequest, UpdateTrackAsLoveCommandResponce>
    {
        ...
        /// <returns></returns>
        public override UpdateTrackAsLoveCommandResponce Execute(
            UpdateTrackAsLoveRequest request)
        {
    ...
    /// </summary>
    public class UpdateTrackAsLoveRequest : BaseRequest
    {
        ...
        public UpdateTrackAsLoveRequest()
        {
        }
    ...
    /// </summary>
    public class UpdateTrackAsLoveCommandResponce : LastFmBaseResponce<UpdateTrackAsLoveContainer>
    {
    }

    public class UpdateTrackAsLoveContainer : LastFmBaseContainer
    {
