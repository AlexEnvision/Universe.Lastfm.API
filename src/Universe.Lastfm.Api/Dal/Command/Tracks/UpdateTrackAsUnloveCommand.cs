...
namespace Universe.Lastfm.Api.Dal.Command.Tracks
{
    ...
    public class UpdateTrackAsUnloveCommand : LastCommand<UpdateTrackAsUnloveRequest, UpdateTrackAsUnloveCommandResponce>
    {
        ...
        /// <returns></returns>
        public override UpdateTrackAsUnloveCommandResponce Execute(
            UpdateTrackAsUnloveRequest request)
        {
            ...
            UpdateTrackAsUnloveCommandResponce infoResponce = ResponceExt.CreateFrom<BaseResponce, UpdateTrackAsUnloveCommandResponce>(sessionResponce);
    ...
    /// </summary>
    public class UpdateTrackAsUnloveRequest : BaseRequest
    {
        ...
        public UpdateTrackAsUnloveRequest()
        {
        }

        public static UpdateTrackAsUnloveRequest Build(string artist, 
            string apiSig, string[] tags, string session)
        {
            return new UpdateTrackAsUnloveRequest
            {
                Token = apiSig,
                Performer = artist,
                SessionKey = session
    ...
    /// </summary>
    public class UpdateTrackAsUnloveCommandResponce : LastFmBaseResponce<UpdateTrackAsUnloveContainer>
    {
    }

    public class UpdateTrackAsUnloveContainer : LastFmBaseContainer
    {
