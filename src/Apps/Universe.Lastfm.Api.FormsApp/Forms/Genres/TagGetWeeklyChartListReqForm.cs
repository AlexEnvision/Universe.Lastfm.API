...
{
    public partial class TagGetWeeklyChartListReqForm : TagInfoReqForm
    {
        public TagGetWeeklyChartListReqForm()
        {
            InitializeComponent();
        }

        public TagGetWeeklyChartListReqForm(UniverseLastApiAppSettings settings)
        {
            InitializeComponent();
